...
void sr_handle_arp_req(struct sr_instance* sr, uint8_t *packet, unsigned int len, struct sr_if* iface);

void sr_handle_arp_rep(struct sr_instance* sr, uint8_t *packet, unsigned int len, struct sr_if* iface);
